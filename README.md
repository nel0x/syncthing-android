...
> [!IMPORTANT]
> Syncthing-Fork was previously developed and maintained by [Catfriend1](https://github.com/catfriend1). As they seem to no longer be actively maintaining the project, I will try to continue its maintenance - not just the Play Store releases but the entire app going forward. Thank you Catfriend1 for building and sharing this amazing project and all the effort you put into keeping Syncthing available on Android!
